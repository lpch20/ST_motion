...
forever stop requiro-test
# el forever necesita iniciarse desde el directorio root
cd /root/src/requiro_test/server
forever start --append -o /root/.forever/requiro-test.log -e /root/.forever/requiro-test.err --uid "requiro-test" bin/www_test
