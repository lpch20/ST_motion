...
find /root/db-backup/data/requiro/ -maxdepth 1 -type f -name '*.sql' -mtime +10 -exec mv {} /root/db-backup/data/requiro/archive/ \;
find /root/db-backup/data/requiro/archive/ -maxdepth 1 -type f -name '*.sql' -mtime +30 -exec rm {} \;