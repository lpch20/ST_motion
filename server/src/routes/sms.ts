...
export class SmsRoute extends MainRoute{
    ...
    public routes(): express.Router {
        ...
        let smsController: SmsController = new SmsController(this.masterDBController, this.controllerConnections, this.controllerPromiseConnections, this.acl);
