...
import { BreakTypeModel } from '../models/BreakTypeModel';
...
export class BreakTypeController extends MainController {
    private resource: string;
    private breakTypeModel: BreakTypeModel;
    ...
    constructor(masterDBController: ControllerDBMaster,
        ...
        //TODO Cambiar
        this.resource = "users";
        this.breakTypeModel = new BreakTypeModel();
    }
    ...
    public getAll = (req: express.Request, res: express.Response): void => {
        this.verifyAccess(req, res, this.resource, (dbName: string) => {
            this.getPool(dbName,  (con) => {
                this.breakTypeModel.getAll(con, (result: any) => {
                    res.send(result);
                });
            });
        });
